...
class Key {
	...
	ConfContactRequireName    = 'Nether.Atlantis.Contact.RequireName',
	ConfContactRequireEmail   = 'Nether.Atlantis.Contact.RequireEmail',
	ConfContactRequirePhone   = 'Nether.Atlantis.Contact.RequirePhone',
